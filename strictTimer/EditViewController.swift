...
class EditViewController: UIViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        titleField.text = dictKey
        
        print("here1")
        
        pickerView1.selectRow(dataList.index(of: String(originalData[0]))!, inComponent: 0, animated: false)
        pickerView2.selectRow(dataList.index(of: String(originalData[1]))!, inComponent: 0, animated: false)
        pickerView3.selectRow(dataList.index(of: String(originalData[2]))!, inComponent: 0, animated: false)
        
        
        if (originalData.count == 5){
            pickerView4.selectRow(dataList.index(of: String(originalData[3]))!, inComponent: 0, animated: false)
            pickerView5.selectRow(dataList.index(of: String(originalData[4]))!, inComponent: 0, animated: false)
